...
# devtools::load_all() reloads all code Ctrl/Cmd + Shift + L saves all open files and reloads code This keyboard shortcut leads to a fluid development workflow:
# Edit an R file.  Press Ctrl/Cmd + Shift + L.  Explore the code in the console.  Rinse and repeat.
